...
public class MiddleDeck : MonoBehaviour
{
    ...
    { //adds card
        ...
        cards_ = deck_.GetComponent<MiddleDeck>().cardDeck;
        ...
        else
        {
            ...
            if (cards_[cards_.Count - 1].GetComponent<Card>().number + order == controller.selectedCard[0].GetComponent<Card>().number)
            {
                ...
                if (cards_[cards_.Count - 1].GetComponent<Card>().suit == controller.selectedCard[0].GetComponent<Card>().suit)
                {
